...
2.The multiplexers select the corresponding register outputs and then the selected register values appear at the read outputs.
...
Two registers can be accessed at the same time, which matches the dual-read behavior of a RISC-V register file.
